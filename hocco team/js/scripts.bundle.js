...
document.querySelectorAll('.logo-with-links .toggle-links').forEach(logo => {
  logo.addEventListener('click', function(e) {
    e.stopPropagation();
    const links = this.parentElement.querySelector('.logo-links');
    const isVisible = links.style.display === 'block';

    // Hide all open dropdowns
    document.querySelectorAll('.logo-links').forEach(el => el.style.display = 'none');
